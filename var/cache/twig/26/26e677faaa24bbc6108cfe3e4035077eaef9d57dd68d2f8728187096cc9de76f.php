...
class __TwigTemplate_2f837e02ae11680804e8ccdc71963279fde98efdebb021cf40b0f4e2e616249d extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            <div>";
            // line 14
            echo twig_escape_filter($this->env, $this->getAttribute($context["article"], "getTruncatedContent", array(0 => 500), "method"), "html", null, true);
            echo "</div>
        </article>
    ";
        }
...
{% block content %}
    ...
    {% for article in articles %}
        <article>
            ...
            <div>{{ article.getTruncatedContent(500) }}</div>
        </article>
    {% endfor %}
